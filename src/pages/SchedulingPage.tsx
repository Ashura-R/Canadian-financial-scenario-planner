...
const SCHEDULED_FIELD_OPTIONS: { value: ScheduledField; label: string; group: string }[] = [
  ...
  { value: 'selfEmploymentExpenses', label: 'SE Expenses', group: 'Deductions' },
  { value: 'childCareExpenses', label: 'Child Care Expenses', group: 'Deductions' },
  { value: 'medicalExpenses', label: 'Medical Expenses', group: 'Deductions' },
  { value: 'unionDues', label: 'Union/Prof. Dues', group: 'Deductions' },
  { value: 'studentLoanInterest', label: 'Student Loan Interest', group: 'Deductions' },
  ...
  { value: 'housingExpense', label: 'Housing Expense', group: 'Living Expenses' },
  { value: 'groceriesExpense', label: 'Groceries Expense', group: 'Living Expenses' },
  { value: 'transportationExpense', label: 'Transportation Expense', group: 'Living Expenses' },
  { value: 'utilitiesExpense', label: 'Utilities Expense', group: 'Living Expenses' },
  { value: 'insuranceExpense', label: 'Insurance Expense', group: 'Living Expenses' },
  { value: 'entertainmentExpense', label: 'Entertainment Expense', group: 'Living Expenses' },
  { value: 'personalExpense', label: 'Personal Expense', group: 'Living Expenses' },
  { value: 'otherLivingExpense', label: 'Other Living Expense', group: 'Living Expenses' },
...
const CONDITION_FIELDS: { value: ConditionField; label: string; group: string }[] = [
  ...
  { value: 'totalLivingExpenses', label: 'Total Living Expenses', group: 'Expenses' },
  { value: 'rentalGrossIncome', label: 'Rental Gross Income', group: 'Income' },
  { value: 'pensionIncome', label: 'Pension Income', group: 'Income' },
  { value: 'foreignIncome', label: 'Foreign Income', group: 'Income' },
