...
function OverlayLine({ data, scenarios, title }: { data: Record<string, any>[]; scenarios: Scenario[]; title: string }) {
  return (
...
function OverlayArea({ data, scenarios, title }: { data: Record<string, any>[]; scenarios: Scenario[]; title: string }) {
  return (
    <ChartCard title={title}>
      <ResponsiveContainer width="100%" height="100%">
